      ...
      <div className="max-w-7xl mx-auto p-4 sm:p-6 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <section className="lg:col-span-2 flex flex-col">
          ...
          <section className="mb-10 border rounded-lg p-6 shadow-sm bg-white">
            <h2 className="text-xl sm:text-2xl font-semibold mb-4">Sports Available</h2>
      ...
      >
        Book This Venue
          ...
          <div className="border rounded-lg p-5 shadow-sm bg-white">
            ...
            <p className="text-base">7:00 AM - 11:00 PM</p>
          </div>
          ...
          <div className="border rounded-lg p-5 shadow-sm bg-white">
            ...
            <address className="not-italic space-y-1 text-base leading-relaxed text-gray-700">
      ...
      {showPricePopup && (
        ...
        >
          ...
          >
            ...
            {/* Replace with your real price chart content */}
            <p>Here you can show the price details for {selectedSport}.</p>
